...
module.exports = class DanbooruCommand extends Command {
    ...
    run(msg) {
        ...
        const embed = new Discord.RichEmbed()
            .setDescription("To invite me to your Server follow this Link")
            .setTitle("https://discordapp.com/oauth2/authorize?&client_id=691622066713133155&scope=bot&permissions=379968")
            .setColor('#FFFFFF')
